...
//   const [selectedSessionType, setSelectedSessionType] = useState('one2one');
//   const dispatch = useDispatch();
//   const [courseData, setCourseData] = useState({});
//   const [loading, setLoading] = useState(true);
//   const [loadingEnroll, setLoadingEnroll] = useState(false);
...
//     setOpen(false);
//     if (option) {
//       localStorage.setItem('sessionType', selectedSessionType);
//       handleEnroll(option);
//     }
//   };
...
//           if (paymentId) {
//             dispatch(payment(values, paymentId, installment, currency))
//               .then((res) => {
//                 const testCheckoutUrl = res.data.session.url;
//                 window.location.href = testCheckoutUrl;
//               });
...
//         const res = await dispatch(getSingleCourse(id));
//         setCourseData(res.data.data);
//         if (['bhajjan', 'tabla', 'ghazal'].includes(res.data.data.courseType)) {
//           setDisableInstallment(true);
//         }
//         dispatch(getRelatedCourses(res.data.data.courseType))
//           .then((res) => {
...
//               {courseData.topics.map((topic, index) => (
//                 <Typography key={index} sx={{ color: "grey", mb: 1 }}>
//                   ● {topic}
//                 </Typography>
//               ))}
//           </Grid>
...
//         <DialogContent>
//           <DialogContentText>
//             Please select your preferred payment option and session type.
//           </DialogContentText>
//           <RadioGroup
...
//           >
//             <FormControlLabel value="one2one" control={<Radio />} label="One-to-One" />
//             <FormControlLabel value="group" control={<Radio />} label="Group" />
//           </RadioGroup>
//         </DialogContent>
//         <DialogActions>
//           {disableInstallment ? (
//             <Button onClick={() => handleDialogClose(price, true, currency)} disabled color="primary">
//               Installment
//             </Button>
//           ) : (
//             <Button onClick={() => handleDialogClose(price, true, currency)} color="primary">
//               Installment
//             </Button>
//           )}
//           <Button onClick={() => handleDialogClose(price, false, currency)} color="primary">
//             Full Fee
//           </Button>
//         </DialogActions>
//       </Dialog>
