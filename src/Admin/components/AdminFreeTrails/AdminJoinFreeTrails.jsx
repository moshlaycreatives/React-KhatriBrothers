...
import { adminChangeTrailStatus, getAdminFreeTrails } from '../../../store/actions/courseActions'; // Import your actions
          ...
          {loading ? (
            ...
            <TableContainer component={Paper} sx={{ padding: '1rem 1rem', boxShadow: '10px 0px 20px 1px rgba(0, 0, 0, 0.1)' }}>
              <Table size='small' aria-label='a dense table'>
                ...
                <TableBody>
                  {classData
                    .filter(row => row.link) // Only show rows with a valid zoomLink
                    .map((row) => {
                        ...
                        <TableRow key={row._id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                          ...
                          <TableCell>
                            <Button
                              ...
                              color="primary"
                              sx={{ borderRadius: '0px', textTransform: 'none' }}
                              onClick={() => handleStatusChange(row.studentId._id)}
