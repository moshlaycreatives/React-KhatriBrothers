...
import AddAdvanceCourse from './components/AddTablaCourse';
import ViewAdvanceCourse from './components/ViewTablaCourse';
...
const TablaCoursesMain = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const filteredCourses = data.filter(course => course.courseType === 'tabla')
