...
import EditIntermediateCourse from "./EditIntermediateCourse";

const ViewIntermediateCourse = ({courseId}) => {
...
{isEditing ? (
        <>
          ...
          <EditIntermediateCourse courseData={courseData}/>
        </>
      ) : (
...
export default ViewIntermediateCourse;
