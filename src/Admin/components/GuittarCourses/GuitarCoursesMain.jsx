...
import AddAdvanceCourse from './components/AddGuitarCourse';
import ViewAdvanceCourse from './components/ViewGuitarCourse';
...
const GuitarCoursesMain = () => {
  ...
  const fetchData = async () => {
    ...
    const filteredCourses = data.filter(course => course.courseType === 'guitar')
