...
import AddAdvanceCourse from './components/AddKeyboardCourse';
import ViewAdvanceCourse from './components/ViewKeyboardCourse';
...
const KeyboardCoursesMain = () => {
  ...
  const fetchData = async () => {
    ...
    const filteredCourses = data.filter(course => course.courseType === 'keyboard')
