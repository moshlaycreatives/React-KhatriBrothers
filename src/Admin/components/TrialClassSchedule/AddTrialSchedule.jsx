...
const AddTrialSchedule = () => {
  ...
  const handleSubmit = () => {
    ...
    if (isValidDate && selectedDateTime.isAfter(now)) {
      ...
      console.log(typeof formatedTimehaha, 'type is ')

      const res = dispatch(trialDateAdmin(formatedTimehaha))
        .then((res) =>
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      ...
      >
        <Card sx={{ padding: "5rem" }}>
          <Typography sx={{fontSize:'1rem', fontWeight:600}}>Select Date</Typography>
          <DatePicker
            value={selectedDate}
          ...
          <Typography sx={{fontSize:'1rem', fontWeight:600}}>Select Time</Typography>
