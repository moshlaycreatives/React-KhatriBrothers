...
import RecentAssignedStudents from "./components/RecentAssignedStudents";
import { useDispatch } from "react-redux";
import { getInstructorDashboardDetail } from "../../../store/actions/courseActions";
...
const dispatch = useDispatch()
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await dispatch(getInstructorDashboardDetail());
        const data = res.data;
