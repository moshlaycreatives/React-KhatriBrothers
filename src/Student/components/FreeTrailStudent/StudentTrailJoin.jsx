...
const StudentTrailJoin = () => {
  ...
  const { formattedDate, formattedTime: formattedStartTime } =
    formatDateAndTime(classData?.startTime);
    ...
    <Box>
      ...
      {loading ? (
        ...
        {!classData ? (
          ...
          <Typography sx={{fontSize:'2rem', fontWeight:'700', textAlign:'center'}}>Please Enroll in Free Trial Class from Khatri Brothers Official website</Typography>
