      ...
      <ul>
        {lectureData[0]?.courseId?.customList?.map((item, index) => (
          ...
          <Box>
            ...
            <Typography>{lectureData[0]?.courseId?.indianPrice}</Typography>
          </Box>
          <br />
          <Box>
        ...
        <Box>
          <Grid container spacing={2}>
            {pdfFiles.map((pdfFile, index) => {
              ...
              const cleanFileName = fileNameWithoutDate.replace(
                /.*T\d+.*Z-/,
                ""
              );
              ...
              return (
                <Grid item xs={12} sm={4} key={index}>
                  ...
                  >
                    ...
                    />
                    <CardContent>
                      <Typography variant="body1">{cleanFileName}</Typography>
                      <br />
                      <Link
                        to={fullUrl}
                        variant="body2"
        ...
        <Grid container spacing={2}>
            ...
            return (
              <Grid item xs={12} sm={3} key={index}>
                <Card variant="outlined">
                  ...
                  <CardContent>
                    <Typography>{cleanFileName}</Typography>
                  </CardContent>
                </Card>
              </Grid>
            );
          ...
          <>
            <Box sx={{display:'flex', justifyContent:'center', alignItems:'center'}}>
              <Typography sx={{fontSize:'1.5rem', fontWeight:'600'}}>No lecture Available for this course</Typography>
            </Box>
          </>
        )}
